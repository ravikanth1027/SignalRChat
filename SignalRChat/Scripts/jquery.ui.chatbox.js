            ...
            boxManager: {
                ...
                addMsg: function (peer, msg) {
                    ...
                    if (msg.includes('#')) {
                        ...
                        var imagePath = resolveUrl("Uploads/");
                        //console.log("file Name:", imagePath + fileName[fileName.length - 1])
                        //$(msgElement).attr("href", array[1]);
                        $(msgElement).attr("href", imagePath + fileName[fileName.length - 1]);
                        $(msgElement).attr("download", imagePath + fileName[fileName.length - 1]);
